...
void LCD_WriteNibble(unsigned char nibbleToWrite)
{
  GPIO_WriteBit(LCD_GPIO, LCD_EN, Bit_SET);
	GPIO_WriteBit(LCD_GPIO, LCD_D4, (nibbleToWrite & 0x01)>0);
	GPIO_WriteBit(LCD_GPIO, LCD_D5, (nibbleToWrite & 0x02)>0);
	GPIO_WriteBit(LCD_GPIO, LCD_D6, (nibbleToWrite & 0x04)>0);
	GPIO_WriteBit(LCD_GPIO, LCD_D7, (nibbleToWrite & 0x08)>0);
